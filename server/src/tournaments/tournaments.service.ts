    ...
    for (const m of tournament.matches) {
      if (!table[m.home_team_id]) {
        table[m.home_team_id] = {
          team: {
            id: m.teams_matches_home_team_idToteams.id,
            name: m.teams_matches_home_team_idToteams.name,
          },
          played: 0,
          won: 0,
          drawn: 0,
      ...
      if (!table[m.away_team_id]) {
        table[m.away_team_id] = {
          team: {
            id: m.teams_matches_away_team_idToteams.id,
            name: m.teams_matches_away_team_idToteams.name,
          },
          played: 0,
          won: 0,
          drawn: 0,
